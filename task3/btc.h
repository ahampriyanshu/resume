...
void print_uint_8(uint8_t *, uint32_t);
...
int8_t *unsigned_to_signed(int8_t *, uint32_t, int8_t *, uint32_t, int8_t *, uint32_t, uint32_t *);

uint8_t *serialise_unsigned_txn(struct unsigned_txn *, int32_t, uint32_t *);
